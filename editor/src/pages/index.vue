...
<template>
  <div class="h-screen">
    <t-layout style="height: 100%">
      <t-header style="height: 56px; padding: 0; border-bottom: 1px solid var(--td-component-stroke)">
        <div class="flex h-full items-center justify-between px-4">
          ...
          <div class="flex items-center gap-2">
            ...
            <t-button variant="outline" size="small" @click="auth.logout">
              退出
            </t-button>
          </div>
        </div>
      ...
      <t-layout style="min-height: 0; overflow: hidden">
        <t-aside
          v-if="!isMobile"
          width="192px"
          style="overflow-y: auto; border-right: 1px solid var(--td-component-stroke)"
        >
        ...
        <t-layout>
          <t-content style="padding: 0; overflow: hidden; display: flex; flex-direction: column">
            <div
